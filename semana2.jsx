    ...
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-12 pb-24 animate-in fade-in duration-500">
      ...
      <section className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl shadow-sm border border-indigo-100">
        ...
        <ul className="space-y-5">
          ...
          <li className="flex items-start gap-4 bg-white/60 p-4 rounded-xl border border-indigo-200 shadow-sm">
            <div className="bg-indigo-600 rounded-full p-1.5 mt-0.5 shrink-0 shadow-sm">
              <CheckCircle className="w-5 h-5 text-white" />
            </div>
            <p className="text-indigo-900 font-medium text-lg leading-relaxed m-0">
              <strong>La conexión del ciclo de trabajo:</strong> Una vez finalizado el exhaustivo trabajo de preprocesamiento (preparar el terreno, balancear y limpiar los datos), el siguiente paso lógico es <strong>abrir la caja de herramientas de la Semana 1</strong> para elegir el algoritmo matemático adecuado y comenzar el entrenamiento. ¡Todo está conectado!
            </p>
          </li>
        </ul>
      </section>
      ...
      <section className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 mt-8">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          >
            <ExternalLink className="w-4 h-4" /> Abrir PDF Semana 2
          </a>
          <a
            href="/pdfs/Semana 2.pdf"
            download
